create function public.queue_application_preparation(
  p_job_id bigint,
...
create function public.claim_next_application_preparation(p_worker_id text)
returns table (
  application_id uuid,
  owner_id uuid,
  job jsonb,
...
create function public.record_application_package(
...
create function public.fail_application_preparation(p_application_id uuid, p_questions jsonb, p_error_code text default null)
returns void
language plpgsql
set search_path = ''
as $$
